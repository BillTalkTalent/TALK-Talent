      ...
      <div className="px-5 flex items-center h-14 gap-1">
        ...
        <Link href="/dashboard" className="flex items-center gap-2 mr-5 shrink-0">
          ...
          <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
            <rect width="34" height="34" rx="9" fill="#7c72ec"/>
        ...
        <div className="flex items-center gap-1 ml-3 shrink-0">
          ...
          >
            ...
            <span className="text-sm font-semibold text-indigo-100 hidden md:block group-hover:text-white transition-colors">
          ...
          <button
            ...
            title="Sign out"
            className="flex items-center justify-center size-9 rounded-lg text-indigo-400 hover:text-red-300 hover:bg-white/10 transition-all"
          >
