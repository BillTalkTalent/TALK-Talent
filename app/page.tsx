          ...
          <div className="relative rounded-2xl overflow-hidden border" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.1)', borderColor: C.border }}>
            ...
            <div className="p-5 space-y-4" style={{ background: C.bgAlt }}>
              ...
              <div className="grid grid-cols-4 gap-3">
                {(['linear-gradient(135deg,#00b894,#00d4aa)','linear-gradient(135deg,#ea580c,#f97316)','linear-gradient(135deg,#7c3aed,#8b5cf6)','linear-gradient(135deg,#1d4ed8,#3b82f6)'] as const).map((grad, i) => (
      ...
      <footer className="border-t py-10 px-6" style={{ borderColor: C.border }}>
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs" style={{ color: C.subtle }}>
            ...
            <a href="https://talktalent.com/privacy" className="hover:text-zinc-700 transition-colors">Privacy</a>
            <a href="https://talktalent.com/terms" className="hover:text-zinc-700 transition-colors">Terms</a>
