          ...
          return (
            <div
              ...
              className={cn(
                ...
                joined
                  ? "border-indigo-400 bg-gradient-to-br from-indigo-50 to-violet-50"
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                {joined && (
                  <span className="inline-flex items-center gap-1 text-[11px] font-bold text-indigo-600 bg-white border border-indigo-200 px-2 py-0.5 rounded-full shadow-sm">
                    <Check className="size-3" /> Joined
                  </span>
                )}
              </div>

              <p className={cn("font-bold text-base", joined ? "text-indigo-900" : "text-zinc-900")}>
                {chapter.name}
              </p>
              {chapter.description && (
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-zinc-100">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    joined
                      ? "bg-white text-indigo-600 border border-indigo-200 hover:bg-red-50 hover:text-red-600 hover:border-red-200"
