...
// Split: navy hero → white body
// Hero bg is deep navy #0f172a (not pure black)
  ...
  return (
    <div className="min-h-screen font-sans bg-white text-zinc-900">
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 bg-zinc-900/90 backdrop-blur px-4 py-2.5 rounded-full shadow-2xl border border-white/10 text-xs font-bold">
        ...
        <span className="text-white bg-white/15 px-3 py-1 rounded-full">Split</span>
      ...
      {/* ── Nav — stays dark, matching the app ── */}
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5" style={{ background: 'rgba(15,23,42,0.92)', backdropFilter: 'blur(12px)' }}>
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 554 475" height="30" style={{ width: 'auto' }} aria-hidden="true">
              <defs><linearGradient id="pa-s" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#9B5CFF"/><stop offset="100%" stopColor="#6F2CFF"/></linearGradient></defs>
              <g transform="translate(110 95)">
                ...
                <path d="M248 178 H352 C375 178 392 195 392 218 V240 C392 267 371 288 344 288 H250 C222 288 202 267 202 240 V224 C202 197 221 178 248 178Z" fill="url(#pa-s)"/>
          ...
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm font-medium text-white/60 hover:text-white transition-colors px-4 py-2">Sign in</Link>
      ...
      {/* ── HERO — deep navy, not pure black ── */}
      <section className="relative pt-40 pb-32 px-6 overflow-hidden" style={{ background: 'linear-gradient(160deg, #0f172a 0%, #0f1f35 60%, #0f172a 100%)' }}>
        {/* Softer glow — teal */}
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full opacity-15 blur-[100px] pointer-events-none" style={{ background: '#F07058' }} />
        {/* Subtle purple accent right */}
        <div className="absolute top-32 right-10 w-72 h-72 rounded-full opacity-10 blur-[80px] pointer-events-none" style={{ background: '#9B5CFF' }} />
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-5 mb-10">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 554 475" height="80" style={{ width: 'auto', filter: 'drop-shadow(0 0 30px rgba(0,212,170,0.25))' }} aria-hidden="true">
              <defs><linearGradient id="pa-sh" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#9B5CFF"/><stop offset="100%" stopColor="#6F2CFF"/></linearGradient></defs>
              <g transform="translate(110 95)">
                <path d="M218 62 H342 C402 62 444 105 444 165 V221 C444 281 402 324 342 324 H272 L335 380 L256 324 H218 C158 324 116 281 116 221 V165 C116 105 158 62 218 62Z" fill="none" stroke="#fff" strokeWidth="24" strokeLinejoin="round"/>
                <path d="M248 178 H352 C375 178 392 195 392 218 V240 C392 267 371 288 344 288 H250 C222 288 202 267 202 240 V224 C202 197 221 178 248 178Z" fill="url(#pa-sh)"/>
                <path d="M50 0 H268 C330 0 374 44 374 106 V175 C374 237 330 281 268 281 H206 L206 333 C206 346 191 353 181 344 L113 281 H50 C20 281 0 261 0 231 V50 C0 20 20 0 50 0Z" fill="#fff"/>
                <rect x="126" y="78" width="208" height="38" rx="19" fill="#000" opacity="0.9"/>
                <path d="M126 154 H270 C282 154 292 164 292 176 C292 188 282 198 270 198 H225 V281 C225 293 215 303 203 303 C191 303 181 293 181 281 V198 H126 C114 198 104 188 104 176 C104 164 114 154 126 154Z" fill="#000" opacity="0.9"/>
              </g>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup"
              ...
              style={{ background: 'linear-gradient(135deg, #E8503A, #F07058)', color: '#0d0d0d', boxShadow: '0 8px 32px rgba(0,212,170,0.3)' }}>
              Apply for membership <ArrowRight className="size-4" />
            </Link>
            <Link href="/login"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-base font-semibold text-white/60 hover:text-white border border-white/15 hover:border-white/25 transition-all">
        ...
        {/* Mockup — floats at bottom of hero, overlapping into white */}
        <div className="relative max-w-5xl mx-auto mt-16">
          <div className="absolute -inset-1 rounded-3xl blur-2xl opacity-30" style={{ background: 'linear-gradient(135deg, #F0705833, #9B5CFF22)' }} />
          <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.4)] border border-white/10">
            <div className="flex items-center gap-2 px-4 h-11" style={{ background: 'linear-gradient(90deg, #0d0d0d, #1a1a2e)' }}>
              <div className="flex items-center gap-1.5 mr-4 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 554 475" height="22" style={{ width: 'auto' }} aria-hidden="true">
                  <defs><linearGradient id="pa-sm" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#9B5CFF"/><stop offset="100%" stopColor="#6F2CFF"/></linearGradient></defs>
                  <g transform="translate(110 95)">
                    <path d="M218 62 H342 C402 62 444 105 444 165 V221 C444 281 402 324 342 324 H272 L335 380 L256 324 H218 C158 324 116 281 116 221 V165 C116 105 158 62 218 62Z" fill="none" stroke="#fff" strokeWidth="24" strokeLinejoin="round"/>
                    <path d="M248 178 H352 C375 178 392 195 392 218 V240 C392 267 371 288 344 288 H250 C222 288 202 267 202 240 V224 C202 197 221 178 248 178Z" fill="url(#pa-sm)"/>
                    <path d="M50 0 H268 C330 0 374 44 374 106 V175 C374 237 330 281 268 281 H206 L206 333 C206 346 191 353 181 344 L113 281 H50 C20 281 0 261 0 231 V50 C0 20 20 0 50 0Z" fill="#fff"/>
                    <rect x="126" y="78" width="208" height="38" rx="19" fill="#000" opacity="0.9"/>
                    <path d="M126 154 H270 C282 154 292 164 292 176 C292 188 282 198 270 198 H225 V281 C225 293 215 303 203 303 C191 303 181 293 181 281 V198 H126 C114 198 104 188 104 176 C104 164 114 154 126 154Z" fill="#000" opacity="0.9"/>
                  </g>
              ...
              {[{ w: 'w-14', active: true }, { w: 'w-12' }, { w: 'w-20' }, { w: 'w-8' }, { w: 'w-10' }, { w: 'w-14' }].map((item, i) => (
            ...
            <div className="p-5 space-y-4 bg-slate-50">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[0,1].map(i => (
                  <div key={i} className="rounded-xl bg-white border border-zinc-100 shadow-sm p-4 space-y-2.5">
                    <div className="h-3 w-28 rounded bg-zinc-200" />
                    {[0,1,2].map(j => <div key={j} className="h-8 rounded-lg bg-zinc-50 border border-zinc-100" />)}
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ── REST OF PAGE IS WHITE — clean transition ── */}
      ...
      <section className="py-28 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: Users,        title: 'Member Directory', desc: 'Connect with vetted TA leaders across industries, company sizes, and specializations.', color: '#F07058', bg: '#f0fdf9' },
              { icon: CalendarDays, title: 'Events & Classes',  desc: 'Live roundtables, workshops, and virtual classes taught by practitioners.', color: '#f97316', bg: '#fff7ed' },
              ...
              <div key={title} className="rounded-2xl p-6 bg-white border border-zinc-100 hover:border-zinc-200 hover:shadow-md transition-all">
      ...
      <section className="py-28 px-6 bg-zinc-50 border-t border-zinc-100">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="rounded-2xl p-8 bg-white border border-zinc-200 shadow-sm">
      ...
      <footer className="border-t border-zinc-100 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="font-black text-zinc-400 tracking-tight">TALK · For TA Leaders</span>
