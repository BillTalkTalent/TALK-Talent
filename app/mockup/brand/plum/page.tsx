...
function Logo({ size = 34, stroke = '#ffffff' }: { size?: number; stroke?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 554 475" height={size} style={{ width: 'auto' }}>
      <defs>
        <linearGradient id="pl-pg" x1="0" y1="0" x2="1" y2="1">
      ...
      <g transform="translate(110 95)">
        ...
        <path d="M248 178 H352 C375 178 392 195 392 218 V240 C392 267 371 288 344 288 H250 C222 288 202 267 202 240 V224 C202 197 221 178 248 178Z" fill="url(#pl-pg)"/>
        ...
        <rect x="126" y="78" width="208" height="38" rx="19" fill="#000" opacity="0.88"/>
        <path d="M126 154 H270 C282 154 292 164 292 176 C292 188 282 198 270 198 H225 V281 C225 293 215 303 203 303 C191 303 181 293 181 281 V198 H126 C114 198 104 188 104 176 C104 164 114 154 126 154Z" fill="#000" opacity="0.88"/>
      </g>
    </svg>
  )
}
