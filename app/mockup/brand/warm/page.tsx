...
function Logo({ size = 34, stroke = '#ffffff' }: { size?: number; stroke?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 554 475" height={size} style={{ width: 'auto' }}>
      <defs>
        <linearGradient id="w-pg" x1="0" y1="0" x2="1" y2="1">
      ...
      <g transform="translate(110 95)">
        ...
        <path d="M248 178 H352 C375 178 392 195 392 218 V240 C392 267 371 288 344 288 H250 C222 288 202 267 202 240 V224 C202 197 221 178 248 178Z" fill="url(#w-pg)"/>
